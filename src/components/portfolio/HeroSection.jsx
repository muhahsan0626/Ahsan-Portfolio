...
export default function HeroSection({ onNavigate }) {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 py-20 sm:py-24 lg:py-0 overflow-hidden"
    >
      ...
      <div className="hidden md:block absolute top-20 right-10 text-primary/20 font-mono text-sm animate-pulse">
        {"{ code }"}
      </div>
      <div className="hidden md:block absolute bottom-40 left-10 text-primary/20 font-mono text-sm animate-pulse delay-300">
        {"</>"}
      </div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex flex-wrap gap-4 sm:gap-6 md:gap-8 lg:gap-10 xl:gap-12 mt-8 sm:mt-10 lg:mt-12 xl:mt-14 justify-center px-4">
            <div className="text-center min-w-[80px] lg:min-w-[100px] xl:min-w-[120px]">
              <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-primary font-mono">
                3+
              </div>
              <div className="text-xs sm:text-sm lg:text-base text-muted-foreground mt-1 lg:mt-2">
                Years Experience
              </div>
            </div>
            <div className="text-center min-w-[80px] lg:min-w-[100px] xl:min-w-[120px]">
